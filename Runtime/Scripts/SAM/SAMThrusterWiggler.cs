    ...
    public class SAMThrusterWiggler : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if(front_prop_link == null || back_prop_link == null) return;
                ...
                front_prop_link.Rotate(Vector3.forward * (float)(_samForceModel.rpm1*2000) * Time.deltaTime);
                back_prop_link.Rotate(Vector3.forward * -(float)(_samForceModel.rpm2*2000) * Time.deltaTime);
            }
        }
    }
