...
namespace VehicleComponents.Actuators
{
    public class VBS : LinkAttachment, IPercentageActuator
    {
        ...
        public void Start()
        {
            ...
            var xDrive = parentMixedBody.ab.xDrive;
        ...
        {
            return (1 - (mixedBody.ab.jointPosition[0]-_minimumPos)  / (_maximumPos - _minimumPos)) * 100;
        }
        ...
        {
            mixedBody.ab.mass = 0.300f + _initialMass * GetCurrentValue() / 100; // Piston weight + water weight
            mixedBody.ab.SetDriveTarget(ArticulationDriveAxis.X, Mathf.Lerp(_maximumPos, _minimumPos, percentage / 100));
        }
    }
}